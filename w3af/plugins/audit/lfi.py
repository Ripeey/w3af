...
class lfi(AuditPlugin):
    ...
    def _analyze_result(self, mutant, response):
        ...
        # http://host.tld/show_user.php?id=show_user.php
        #
        # The calls to smart_bytes_ignore fix a UnicodeDecoreError which appears when
        ...
        #
        filename = smart_bytes_ignore(mutant.get_url().get_file_name())
        token_value = smart_bytes_ignore(mutant.get_token_value())
