        ...
        for worker_state in inspect_data:
            ...
            for arg in worker_state['args']:
                try:
                    ...
                    arg_str = smart_unicode_ignore(arg)
                else:
                    arg_str = smart_unicode_ignore(arg_repr)
            ...
            for key, value in worker_state['kwargs']:
                try:
                    ...
                    value_str = smart_unicode_ignore(value)
                else:
                    value_str = smart_unicode_ignore(value_repr)
            ...
            kwargs_str = smart_unicode_ignore(short_kwargs)

            func_name = smart_unicode_ignore(worker_state['func_name'])
